...
// end 1st
	...
	public class BaseCreature : Mobile, IHonorTarget
	{
        ...
        //    get
        //    {
        //        // Daniel Add Min Armor
        //        if (base.PhysicalResistance < 200)
        //            return 200;
        //        else
        //            return base.PhysicalResistance + (Convert.ToInt32(base.PhysicalResistance * 0.2)); // 20% +
        //    }
        //}
		...
		*/
		...
		public virtual bool AlwaysMurderer
		{
			get
			{
                if (this.FightMode != Mobiles.FightMode.Aggressor && this.FightMode != Mobiles.FightMode.None) //if (Karma < 0)
                    return true;
                else
				    return false;
			}
				...
				if ( hides != 0 )
				{
					...
					if ( Core.AOS && ( holding is SkinningKnife /* TODO: || holding is ButcherWarCleaver || with is ButcherWarCleaver */ ) )
					{
						...
						switch ( HideType )
						{
                            ...
                            case HideType.Spined: leather = new Leather(hides); break;
                            case HideType.Horned: leather = new Leather(hides); break;
                            case HideType.Barbed: leather = new Leather(hides); break;

                            case HideType.CyclopsHide: leather = new CyclopsLeather(hides); break;
                            case HideType.DaemonHide: leather = new DaemonLeather(hides); break;
                            case HideType.DragonGreenHide: leather = new DragonGreenLeather(hides); break;
                            case HideType.DragonHide: leather = new DragonLeather(hides); break;
                            case HideType.GargoyleHide: leather = new GargoyleLeather(hides); break;
                            case HideType.TerathanHide: leather = new TerathanLeather(hides); break;
                            case HideType.ZZHide: leather = new ZZLeather(hides); break;
						}
					...
					else
					{
                        ...
                        if (HideType == HideType.Regular)
                            corpse.DropItem(new Hides(hides));
                        else if (HideType == HideType.CyclopsHide)
                            corpse.DropItem(new CyclopsHides(hides));
                        else if (HideType == HideType.DaemonHide)
                            corpse.DropItem(new DaemonHides(hides));
                        else if (HideType == HideType.DragonGreenHide)
                            corpse.DropItem(new DragonGreenHides(hides));
                        else if (HideType == HideType.DragonHide)
                            corpse.DropItem(new DragonHides(hides));
                        else if (HideType == HideType.GargoyleHide)
                            corpse.DropItem(new GargoyleHides(hides));
                        else if (HideType == HideType.TerathanHide)
                            corpse.DropItem(new TerathanHides(hides));
                        else if (HideType == HideType.ZZHide)
                            corpse.DropItem(new ZZHides(hides));
                        else
                            corpse.DropItem(new Hides(hides));
...
// end 2nd
		...
		public virtual bool NoHouseRestrictions{ get{ return true; } }
		public virtual bool IsHouseSummonable{ get{ return true; } }
