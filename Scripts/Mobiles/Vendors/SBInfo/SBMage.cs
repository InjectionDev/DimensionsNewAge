...
namespace Server.Mobiles
{
	public class SBMage : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			...
			{
				Add( new GenericBuyInfo( typeof( Spellbook ), 1800, 10, 0xEFA, 0 ) );
                Add(new GenericBuyInfo(typeof(Runebook), 2800, 10, 0x22C5, 0x461));

                Add(new GenericBuyInfo(typeof(BagOfReagents), 1540, 10, 0xE76, 0));
				...
				if ( Core.AOS )
				{
                    Add(new GenericBuyInfo(typeof(BatWing), 3, 120, 0xF78, 0));
                    Add(new GenericBuyInfo(typeof(DaemonBlood), 6, 120, 0xF7D, 0));
                    Add(new GenericBuyInfo(typeof(PigIron), 5, 120, 0xF8A, 0));
                    Add(new GenericBuyInfo(typeof(NoxCrystal), 6, 120, 0xF8E, 0));
                    Add(new GenericBuyInfo(typeof(GraveDust), 3, 120, 0xF8F, 0));
				}
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
                ...
                Add(typeof(Spellbook), 1800);
                Add(typeof(Runebook), 2800);
                Add(typeof(BagOfReagents), 1540);
