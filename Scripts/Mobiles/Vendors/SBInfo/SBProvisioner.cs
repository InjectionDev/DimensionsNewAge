		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
                ...
                if (!Guild.NewGuildSystem)
                    Add(new GenericBuyInfo("Escritura de Guilda", typeof(GuildDeed), 100000, 20, 0x14F0, 0));

                Add(new GenericBuyInfo("Contrato com Vendedor", typeof(ContractOfEmployment), 20000, 20, 0x14F0, 0));

                Add(new GenericBuyInfo(typeof(Cofre), 50000, 10, 0xE41, 753));
