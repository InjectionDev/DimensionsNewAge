...
namespace Server.Mobiles
{
	public class VendorAI : BaseAI
	{
		...
		public override void OnSpeech( SpeechEventArgs e )
		{
			...
			{
                if (e.HasKeyword(0x14D) || e.Speech.ToLower().Contains("sell") || e.Speech.ToLower().Contains("vender")) // *vendor sell*
				{
					e.Handled = true;
                ...
                else if (e.HasKeyword(0x3C) || e.Speech.ToLower().Contains("buy") || e.Speech.ToLower().Contains("comprar"))
				{
					e.Handled = true;
