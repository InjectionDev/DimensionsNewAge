...
namespace Server.Regions
{
	public class HouseRegion : BaseRegion
	{
		...
		public override bool SendInaccessibleMessage( Item item, Mobile from )
		{
            ...
            from.SendMessage("Voce nao pode acessar isto.");
		...
		public override void OnSpeech( SpeechEventArgs e )
		{
			...
			else if ( e.HasKeyword( 0x23 ) || e.Speech.Equals("trancar", StringComparison.CurrentCultureIgnoreCase) ) // I wish to lock this down
			{
				if ( isCoOwner )
				{
            ...
            else if (e.HasKeyword(0x24) || e.Speech.Equals("destrancar", StringComparison.CurrentCultureIgnoreCase)) // I wish to release this
			{
				if ( isCoOwner )
				{
            ...
            else if (e.HasKeyword(0x25) || e.Speech.Equals("secure", StringComparison.CurrentCultureIgnoreCase)) // I wish to secure this
			{
				if ( isOwner )
				{
            ...
            else if (e.HasKeyword(0x26) || e.Speech.Equals("unsecure", StringComparison.CurrentCultureIgnoreCase)) // I wish to unsecure this
			{
				if ( isOwner )
				{
