...
namespace Server.Engines.Craft
{
	public class CraftGump : Gump
	{
		...
		private CraftGump( Mobile from, CraftSystem craftSystem, BaseTool tool, object notice, CraftPage page ) : base( 40, 40 )
		{
            ...
            AddBackground(0, 0, 530, 437, 9270); // AddBackground( 0, 0, 530, 437, 5054 );
            ...
            AddHtml(10, 37, 200, 22, "<CENTER><BASEFONT COLOR=#800000>CATEGORIA</CENTER>", false, false); // <CENTER>CATEGORIES</CENTER>
            AddHtml(215, 37, 305, 22, "<CENTER><BASEFONT COLOR=#800000>SELEÇÃO</CENTER>", false, false); // <CENTER>SELECTIONS</CENTER>
            AddHtml(10, 302, 150, 25, "<CENTER><BASEFONT COLOR=#800000>AVISOS</CENTER>", false, false); // <CENTER>NOTICES</CENTER>

			AddButton( 15, 402, 4017, 4019, 0, GumpButtonType.Reply, 0 );
            AddHtml(50, 405, 150, 18, "Sair", false, false); // EXIT

			AddButton( 270, 402, 4005, 4007, GetButtonID( 6, 2 ), GumpButtonType.Reply, 0 );
            AddHtml(305, 405, 150, 18, "Fazer Último", false, false); // MAKE LAST
			...
			if ( craftSystem.Repair )
			{
                ...
                AddHtml(305, 345, 150, 18, "Reparar Item", false, false); // REPAIR ITEM
			}
			// ****************************************

			// Enhance option
			if ( false && craftSystem.CanEnhance )
			{
            ...
            if (notice is int && (int)notice > 0)
            {
                ...
                switch((int)notice)
                {
                    ...
                    case 1044038:
                        m_From.SendMessage("Sua ferramenta quebrou!");
                        AddHtml(170, 295, 350, 40, String.Format("<BASEFONT COLOR=#{0:X6}>{1}</BASEFONT>", FontColor, "Sua ferramenta quebrou!"), false, false);
                        break;
                    case 1044043:
                        m_From.SendMessage("Voce falhou ao criar o item, e perdeu algum material.");
                        AddHtml(170, 295, 350, 40, String.Format("<BASEFONT COLOR=#{0:X6}>{1}</BASEFONT>", FontColor, "Voce falhou ao criar o item, e perdeu algum material."), false, false);
                        break;
                    case 1044157:
                        m_From.SendMessage("Voce falhou ao criar o item, mas nao perdeu nenhum material.");
                        AddHtml(170, 295, 350, 40, String.Format("<BASEFONT COLOR=#{0:X6}>{1}</BASEFONT>", FontColor, "Voce falhou ao criar o item, mas nao perdeu nenhum material."), false, false);
                        break;
                    case 502785:
                        from.SendMessage("Voce criou um item de baixa qualidade.");
                        AddHtml(170, 295, 350, 40, String.Format("<BASEFONT COLOR=#{0:X6}>{1}</BASEFONT>", FontColor, "Voce criou um item de baixa qualidade."), false, false);
                        break;
                    case 1044156:
                        from.SendMessage("Voce criou um item de qualidade excepcional e assinou a obra!");
                        AddHtml(170, 295, 350, 40, String.Format("<BASEFONT COLOR=#{0:X6}>{1}</BASEFONT>", FontColor, "Voce criou um item de qualidade excepcional e assinou a obra!"), false, false);
                        break;
                    case 1044155:
                        from.SendMessage("Voce criou um item de qualidade excepcional!");
                        AddHtml(170, 295, 350, 40, String.Format("<BASEFONT COLOR=#{0:X6}>{1}</BASEFONT>", FontColor, "Voce criou um item de qualidade excepcional!"), false, false);
                        break;
                    case 1044154:
                        from.SendMessage("Voce criou o item.");
                        AddHtml(170, 295, 350, 40, String.Format("<BASEFONT COLOR=#{0:X6}>{1}</BASEFONT>", FontColor, "Voce criou o item."), false, false);
                        break;
		...
		public int CreateGroupList()
		{
            ...
            AddHtml(50, 63, 150, 18, "ULTIMOS DEZ", false, false); // LAST TEN
