...
namespace Server.Engines.Craft
{
	public class CraftGumpItem : Gump
	{
		...
		public CraftGumpItem( Mobile from, CraftSystem craftSystem, CraftItem craftItem, BaseTool tool ) : base( 40, 40 )
		{
			...
			AddPage( 0 );
            AddBackground(0, 0, 530, 417, 9270);
            ...
            AddHtml(170, 40, 150, 20, "<BASEFONT COLOR=#800000>ITEM", false, false); // ITEM
            AddHtml(10, 192, 150, 22, "<CENTER><BASEFONT COLOR=#800000>SKILLS</CENTER>", false, false); // <CENTER>SKILLS</CENTER>
            AddHtml(10, 277, 150, 22, "<CENTER><BASEFONT COLOR=#800000>MATERIAIS</CENTER>", false, false); // <CENTER>MATERIALS</CENTER>
            AddHtml(10, 362, 150, 22, "<CENTER><BASEFONT COLOR=#800000>OUTROS</CENTER>", false, false); // <CENTER>OTHER</CENTER>
            ...
            AddHtml(50, 390, 150, 18, "Voltar", false, false); // BACK
			...
			if( needsRecipe )
			{
				...
				AddHtml( 305, 390, 150, 18, "Fabricar", false, false ); // MAKE NOW
			}
			else
			{
