...
namespace Server.Engines.Craft
{
	public class DefAlchemy : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			AddRes( index, typeof ( Bottle ), 1044529, 1, 500315 );
            index = AddCraft(typeof(LavaExplosionPotion), 1044537, "Lava Explosion", 85.0, 115.0, typeof(SulfurousAsh), 1044359, 15, 1044367);
            AddRes(index, typeof(Bottle), 1044529, 1, 500315);

            // Mana Potion
            index = AddCraft(typeof(LesserManaPotion), "Mana", "Lesser Mana Potion", 5.0, 55.0, typeof(DecoEyeOfNewt), "Eye of Newt", 4, 1044367);
            AddRes(index, typeof(Bottle), 1044529, 1, 500315);
            index = AddCraft(typeof(ManaPotion), "Mana", "Mana Potion", 35.0, 85.0, typeof(DecoEyeOfNewt), "Eye of Newt", 6, 1044367);
            AddRes(index, typeof(Bottle), 1044529, 1, 500315);
            index = AddCraft(typeof(GreaterManaPotion), "Mana", "Greater Mana Potion", 75.0, 115.0, typeof(DecoEyeOfNewt), "Eye of Newt", 12, 1044367);
            AddRes(index, typeof(Bottle), 1044529, 1, 500315);
