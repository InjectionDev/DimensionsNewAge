...
namespace Server.Factions
{
	public class FactionStoneGump : FactionGump
	{
		...
		public FactionStoneGump( PlayerMobile from, Faction faction ) : base( 20, 30 )
		{
            ...
            AddHtml(20, 60, 100, 20, "Comandante:", false, false); // Led By : 
            ...
            AddHtml(20, 100, 100, 20, "Armadilhas colocadas:", false, false); // Traps placed : 
            ...
            AddHtml(55, 225, 200, 20, "Votar para Comandante", false, false); // VOTE FOR LEADERSHIP
            ...
            AddHtml(55, 150, 100, 20, "Status da Cidade", false, false); // CITY STATUS
            AddButton( 20, 150, 4005, 4007, 0, GumpButtonType.Page, 2 );

			//AddHtmlLocalized( 55, 175, 100, 20, 1011444, false, false ); // STATISTICS
            AddHtml(55, 175, 100, 20, "Estatísticas", false, false); // STATISTICS
