	...
	public class HelpGump : Gump
	{
		...
		public HelpGump( Mobile from ) : base( 0, 0 )
		{
			...
			else
			{
				...
				AddHtml( 110, 90, 450, 74, @"<u>Duvidas sobre Ultima Online ou Dimensions.</u> Selecione esta opção para tirar alguma dúvida ingame.", true, true );

				AddButton( 80, 170, 5540, 5541, 2, GumpButtonType.Reply, 0 );
				AddHtml( 110, 170, 450, 74, @"<u>Meu Char está preso ou perdido.</u>", true, true );
