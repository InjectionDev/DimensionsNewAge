			...
			res = new HarvestResource[]
				{
                    ...
                    new HarvestResource( 50.0, 50.0, 100.0, "Voce retirou algum Iron Ore e colocou em sua backpack.", typeof( IronOre ),			typeof( Granite ) ),
					new HarvestResource( 20.0, 20.0, 100.0, "Voce retirou algum Rusty Ore e colocou em sua backpack.", typeof( RustyOre ),		typeof( RustyGranite ) ),
                    new HarvestResource( 55.0, 55.0, 100.0, "Voce retirou algum Old Copper Ore e colocou em sua backpack.", typeof( OldCopperOre ),	typeof( OldCopperGranite ) ),
                    new HarvestResource( 60.0, 60.0, 100.0, "Voce retirou algum Dull Copper Ore e colocou em sua backpack.", typeof( DullCopperOre ),	typeof( DullCopperGranite ) ),
                    new HarvestResource( 60.0, 60.0, 100.0, "Voce retirou algum Ruby Ore e colocou em sua backpack.", typeof( RubyOre ),			typeof( RubyGranite ) ),
                    new HarvestResource( 65.0, 65.0, 100.0, "Voce retirou algum Copper Ore e colocou em sua backpack.", typeof( CopperOre ),		typeof( CopperGranite ) ),
                    new HarvestResource( 70.0, 70.0, 100.0, "Voce retirou algum Bronze Ore e colocou em sua backpack.", typeof( BronzeOre ),		typeof( BronzeGranite ) ),
                    new HarvestResource( 74.0, 74.0, 100.0, "Voce retirou algum Shadow Ore e colocou em sua backpack.", typeof( ShadowIronOre ),	typeof( ShadowIronGranite ) ),
                    new HarvestResource( 78.0, 78.0, 100.0, "Voce retirou algum Silver Ore e colocou em sua backpack.", typeof( SilverOre ),		typeof( SilverGranite ) ),
                    new HarvestResource( 78.0, 78.0, 100.0, "Voce retirou algum Mercury Ore e colocou em sua backpack.", typeof( MercuryOre ),		typeof( MercuryGranite ) ),
                    new HarvestResource( 82.0, 82.0, 100.0, "Voce retirou algum Rose Ore e colocou em sua backpack.", typeof( RoseOre ),			typeof( RoseGranite ) ),
                    new HarvestResource( 85.0, 85.0, 150.0, "Voce retirou algum Gold Ore e colocou em sua backpack.", typeof( GoldOre ),			typeof( GoldGranite ) ),
                    new HarvestResource( 88.0, 88.0, 150.0, "Voce retirou algum Agapite Ore e colocou em sua backpack.", typeof( AgapiteOre ),		typeof( AgapiteGranite ) ),
                    new HarvestResource( 91.0, 91.0, 150.0, "Voce retirou algum Verite Ore e colocou em sua backpack.", typeof( VeriteOre ),		typeof( VeriteGranite ) ),
                    new HarvestResource( 91.0, 91.0, 150.0, "Voce retirou algum Plutonio Ore e colocou em sua backpack.", typeof( PlutoniumOre ),		typeof( PlutonioGranite ) ),
                    new HarvestResource( 94.0, 94.0, 150.0, "Voce retirou algum BloodRock Ore e colocou em sua backpack.", typeof( BloodRockOre ),	typeof( BloodRockGranite ) ),
                    new HarvestResource( 97.0, 97.0, 150.0, "Voce retirou algum Valorite Ore e colocou em sua backpack.", typeof( ValoriteOre ),		typeof( ValoriteGranite ) ),
                    new HarvestResource( 100.0, 100.0, 150.0, "Voce retirou algum BlackRock Ore e colocou em sua backpack.", typeof( BlackRockOre ),	typeof( BlackRockGranite ) ),
                    new HarvestResource( 105.0, 105.0, 150.0, "Voce retirou algum Mytheril Ore e colocou em sua backpack.", typeof( MytherilOre ),		typeof( MytherilGranite ) ),
                    new HarvestResource( 105.0, 105.0, 150.0, "Voce retirou algum Aqua Ore e colocou em sua backpack.", typeof( AquaOre ),			typeof( AquaGranite ) ),
				};
			...
			veins = new HarvestVein[]
				{
					...
					new HarvestVein( 20.0, 0.5, res[1], res[0] ), // RustyOre
					new HarvestVein( 07.0, 0.5, res[2], res[0] ), 
					new HarvestVein( 06.0, 0.5, res[3], res[0] ), 
					new HarvestVein( 06.0, 0.5, res[4], res[0] ), 
					new HarvestVein( 05.0, 0.5, res[5], res[0] ), 
					new HarvestVein( 05.0, 0.5, res[6], res[0] ), 
					new HarvestVein( 05.0, 0.5, res[7], res[0] ), 
                    new HarvestVein( 04.0, 0.5, res[8], res[0] ), 
                    new HarvestVein( 04.0, 0.5, res[9], res[0] ), 
                    new HarvestVein( 04.0, 0.5, res[10], res[0] ), 
                    new HarvestVein( 04.0, 0.5, res[11], res[0] ), 
                    new HarvestVein( 02.0, 0.5, res[12], res[0] ), 
                    new HarvestVein( 02.0, 0.5, res[13], res[0] ), 
                    new HarvestVein( 02.0, 0.5, res[14], res[0] ), 
                    new HarvestVein( 01.0, 0.5, res[15], res[0] ), 
                    new HarvestVein( 01.0, 0.5, res[16], res[0] ), 
					new HarvestVein( 01.0, 0.5, res[17], res[0] ),
                    new HarvestVein( 00.6, 0.5, res[18], res[0] ),  
                    new HarvestVein( 00.4, 0.5, res[19], res[0] )  // Aqua
				};
