...
namespace Server
{
	public class LootPack
	{
        ...
        public static readonly LootPackItem[] MagicDyeTube = new LootPackItem[]
			{
				new LootPackItem( typeof( Server.Items.MagicDyeTub ), 1 )
			};

        public static readonly LootPackItem[] Regs = new LootPackItem[]
			{
				new LootPackItem( typeof( Server.Items.Bloodmoss ), 1 ),
                new LootPackItem( typeof( Server.Items.BlackPearl ), 1 ),
                new LootPackItem( typeof( Server.Items.Garlic ), 1 ),
                new LootPackItem( typeof( Server.Items.Ginseng ), 1 ),
                new LootPackItem( typeof( Server.Items.MandrakeRoot ), 1 ),
                new LootPackItem( typeof( Server.Items.Nightshade ), 1 ),
                new LootPackItem( typeof( Server.Items.SulfurousAsh ), 1 ),
                new LootPackItem( typeof( Server.Items.SpidersSilk ), 1 )
			};

        public static readonly LootPack LootPackBalron = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry(  true, Gold,			100.00, new Random().Next(10000, 12000) ),
                new LootPackEntry(  true, MagicDyeTube,	100.00, 1 ),

                new LootPackEntry(  true, Regs,	100.00, new Random().Next(20,30) ),
                new LootPackEntry(  true, Regs,	100.00, new Random().Next(20,30) ),
                new LootPackEntry(  true, Regs,	100.00, new Random().Next(20,30) ),
                new LootPackEntry(  true, Regs,	100.00, new Random().Next(20,30) ),
