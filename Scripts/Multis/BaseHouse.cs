...
namespace Server.Multis
{
	public abstract class BaseHouse : BaseMulti
	{
		...
		public virtual TimeSpan DecayPeriod{ get{ return TimeSpan.FromDays( 60.0 ); } }
		...
		public bool HasAccess( Mobile m )
		{
            ...
            {
                Console.WriteLine("m.AccessLevel > AccessLevel.Player || IsFriend(m) || (m_Access != null && m_Access.Contains(m))");
                return true;
            }
	...
	public class SecureTarget : Target
	{
		...
		protected override void OnTarget( Mobile from, object targeted )
		{
            ...
            if (!(targeted is Cofre))
            {
                from.SendMessage("Isto nao é um Cofre!");
                return;
            }
