...
namespace Server.Items
{
	...
	public class Corpse : Container, ICarvable
	{
        ...
        public static readonly TimeSpan MonsterLootRightSacrifice = TimeSpan.Zero; //TimeSpan.FromMinutes( 2.0 );

		public static readonly TimeSpan InstancedCorpseTime = TimeSpan.Zero; //TimeSpan.FromMinutes( 3.0 );
		...
		private static TimeSpan m_DefaultDecayTime = TimeSpan.FromMinutes( 17.0 );
