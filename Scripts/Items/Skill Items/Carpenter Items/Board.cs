...
namespace Server.Items
{
	...
	public class Board : Item, ICommodity
	{
		...
		{ 
			get
			{
				if ( m_Resource >= CraftResource.OakWood && m_Resource <= CraftResource.FireWood )
				...
				switch ( m_Resource )
				{
                    ...
                    case CraftResource.FineWood: return -1;
                    case CraftResource.PoisonWood: return -1;
                    case CraftResource.FireWood: return -1;
				}
    ...
    public class FineBoard : Board
    {
        ...
        {
            Name = "Fine Board";
            Hue = DimensionsNewAge.Scripts.HueWoodConst.HueFineWood;
        }

        [Constructable]
        public FineBoard(int amount)
            : base(CraftResource.FineWood, amount)
        {
            Name = "Fine Board";
            Hue = DimensionsNewAge.Scripts.HueWoodConst.HueFineWood;
        }

        public FineBoard(Serial serial)
            : base(serial)
        {
        }
    ...
    public class PoisonBoard : Board
    {
        [Constructable]
        public PoisonBoard()
            : this(1)
        {
            Name = "Poison Board";
            Hue = DimensionsNewAge.Scripts.HueWoodConst.HuePoisonWood;
        }

        [Constructable]
        public PoisonBoard(int amount)
            : base(CraftResource.PoisonWood, amount)
        {
            Name = "Poison Board";
            Hue = DimensionsNewAge.Scripts.HueWoodConst.HuePoisonWood;
        }

        public PoisonBoard(Serial serial)
            : base(serial)
        {
        }
    ...
    public class FireBoard : Board
    {
        ...
        {
            Name = "Fire Board";
            Hue = DimensionsNewAge.Scripts.HueWoodConst.HueFireWood;
        }

        [Constructable]
        public FireBoard(int amount)
            : base(CraftResource.FireWood, amount)
        {
            Name = "Fire Board";
            Hue = DimensionsNewAge.Scripts.HueWoodConst.HueFireWood;
        }

        public FireBoard(Serial serial)
            : base(serial)
        {
        }
