...
namespace Server.Items
{
    ...
    public class FineLog : Log
    {
        ...
        public override bool Axe(Mobile from, BaseAxe axe)
        {
            if (!TryCreateBoards(from, 95, new FineBoard()))
                return false;
    ...
    public class PoisonLog : Log
    {
        ...
        public PoisonLog(Serial serial)
            : base(serial)
        {
        }
        ...
        public override bool Axe(Mobile from, BaseAxe axe)
        {
            if (!TryCreateBoards(from, 95, new PoisonBoard()))
                return false;
    ...
    public class FireLog : Log
    {
        ...
        public override bool Axe(Mobile from, BaseAxe axe)
        {
            if (!TryCreateBoards(from, 95, new FireBoard()))
                return false;
