    ...
    public abstract class BaseArmor : Item, IScissorable, IFactionItem, ICraftable, IWearableDurability
    {
        ...
        public virtual double ArmorRating
        {
            get
            {
                ...
                switch (m_Resource)
                {
                    ...
                    case CraftResource.Rusty: ar += 1; break;
                    case CraftResource.OldCopper: ar += 2; break;
                    case CraftResource.DullCopper: ar += 3; break;
                    case CraftResource.Ruby: ar += 4; break;
                    case CraftResource.Copper: ar += 5; break;
                    case CraftResource.Bronze: ar += 6; break;
                    case CraftResource.ShadowIron: ar += 7; break;
                    case CraftResource.Silver: ar += 8; break;
                    case CraftResource.Mercury: ar += 9; break;
                    case CraftResource.Rose: ar += 10; break;
                    case CraftResource.Gold: ar += 11; break;
                    case CraftResource.Agapite: ar += 12; break;
                    case CraftResource.Verite: ar += 13; break;
                    case CraftResource.Plutonio: ar += 14; break;
                    case CraftResource.BloodRock: ar += 15; break;
                    case CraftResource.Valorite: ar += 16; break;
                    case CraftResource.BlackRock: ar += 17; break;
                    case CraftResource.Mytheril: ar += 18; break;
                    case CraftResource.Aqua: ar += 19; break;
                    ...
                    case CraftResource.CyclopsLeather: ar += 6; break;
                    case CraftResource.GargoyleLeather: ar += 8; break;
                    case CraftResource.TerathanLeather: ar += 10; break;
                    case CraftResource.DaemonLeather: ar += 12; break;
                    case CraftResource.DragonLeather: ar += 14; break;
                    case CraftResource.ZZLeather: ar += 16; break;
                    case CraftResource.DragonGreenLeather: ar += 18; break;
                }

                ar += -8 + (8 * (int)m_Quality);
                //Console.WriteLine("ScaleArmorByDurability: " + ScaleArmorByDurability(ar));
        ...
        public override void AddNameProperty(ObjectPropertyList list)
        {
            ...
            switch (m_Resource)
            {
                ...
                case CraftResource.Iron: oreType = 1063550; break;
                case CraftResource.Rusty: oreType = 1063551; break;
                case CraftResource.OldCopper: oreType = 1063552; break;
                case CraftResource.DullCopper: oreType = 1063553; break;
                case CraftResource.Ruby: oreType = 1063554; break;
                case CraftResource.Copper: oreType = 1063555; break;
                case CraftResource.Bronze: oreType = 1063556; break;
                case CraftResource.ShadowIron: oreType = 1063557; break;
                case CraftResource.Silver: oreType = 1063558; break;
                case CraftResource.Mercury: oreType = 1063559; break;
                case CraftResource.Rose: oreType = 1063560; break;
                case CraftResource.Gold: oreType = 1063561; break;
                case CraftResource.Agapite: oreType = 1063562; break;
                case CraftResource.Verite: oreType = 1063563; break;
                case CraftResource.Plutonio: oreType = 1063564; break;
                case CraftResource.BloodRock: oreType = 1063565; break;
                case CraftResource.Valorite: oreType = 1063566; break;
                case CraftResource.BlackRock: oreType = 1063567; break;
                case CraftResource.Mytheril: oreType = 1063568; break;
                case CraftResource.Aqua: oreType = 1063569; break;
            ...
            if (m_Quality == ArmorQuality.Exceptional)
            {
                if (oreType != 0)
                {
                    //list.Add("exceptional {0}", GetNameString());
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            {
                list.Add("HP: {0}",  prop.ToString());
                //list.Add(1060410, prop.ToString()); // durability ~1_val~%
            }

            if ((prop = ComputeStatReq(StatType.Str)) > 0)
            {
                list.Add("Min Str: {0}", prop.ToString()); // strength requirement ~1_val~
                //list.Add(1061170, prop.ToString()); // strength requirement ~1_val~
            }

            if (m_HitPoints >= 0 && m_MaxHitPoints > 0)
            {
                list.Add("HP: {0}/{1}", m_HitPoints, m_MaxHitPoints); // durability ~1_val~ / ~2_val~
