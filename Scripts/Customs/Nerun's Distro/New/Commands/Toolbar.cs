		...
		public static List<string> DefaultEntries( int i )
		{
			...
			switch(i)
			{
				...
				case 4: // Administrator
					...
					entries.Add(".SpawnEditor"); entries.Add(".Move"); entries.Add(".M Remove"); entries.Add(".Wipe"); entries.Add(".Props"); entries.Add(".Recover"); entries.Add(".Self Unhide"); for( int j = 0; j < 1; j++ ){entries.Add("-");}
