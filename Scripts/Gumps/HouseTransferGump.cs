...
namespace Server.Gumps
{
	public class HouseTransferGump : Gump
	{
		...
		public HouseTransferGump( Mobile from, Mobile to, BaseHouse house ) : base( 110, 100 )
		{
			 ...
			 */
            AddHtml(10, 40, 400, 200, "Um jogador está tentando negociar uma casa com voce, <br>para isto, vocês dois precisam estar em um tile dentro da casa <br>para a transação ser efetuada.", false, true);

			AddImageTiled( 10, 250, 400, 20, 2624 );
			//AddAlphaRegion( 10, 250, 400, 20 );

			AddButton( 10, 250, 4005, 4007, 1, GumpButtonType.Reply, 0 );
			AddHtml( 40, 250, 170, 20, "Continuar", false, false ); // OKAY
