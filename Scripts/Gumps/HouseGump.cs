...
namespace Server.Gumps
{
	public class HouseListGump : Gump
	{
		...
		public HouseListGump( int number, ArrayList list, BaseHouse house, bool accountOf ) : base( 20, 30 )
		{
            ...
            AddBackground(0, 0, 420, 430, 9270);
	...
	public class HouseGump : Gump
	{
		...
		public HouseGump( Mobile from, BaseHouse house ) : base( 20, 30 )
		{
            ...
            AddHtml(20, 135, 100, 20, "Dono:", false, false); // Owned by:
            ...
            AddHtml(20, 170, 275, 20, "Total Itens Locked Down:", false, false); // Number of locked down items:
            ...
            AddHtml(20, 190, 275, 20, "Máximo Itens Locked Down:", false, false); // Maximum locked down items:
            ...
            AddHtml(20, 210, 275, 20, "Total Secure Containers:", false, false); // Number of secure containers:
            ...
            AddHtml(20, 230, 275, 20, "Máximo Secure Containers:", false, false); // Maximum number of secure containers:
			...
			if ( m_House.Public )
			{
                ...
                AddHtml(20, 305, 275, 20, "Total Visitas públicas a esta casa", false, false); // Number of visits this building has had
            ...
            AddHtml(225, 190, 155, 20, "Remover Todos os Amigos", false, false); // Clear Friends list
            ...
            AddHtml(120, 215, 280, 20, "Banir alguém da casa", false, false); // Ban someone from the house
            ...
            AddHtml(120, 235, 280, 20, "Kickar alguém da casa", false, false); // Eject someone from the house
            ...
            AddHtml(120, 255, 280, 20, "Lista de Bans", false, false); // View a list of banned people
            AddButton( 95, 255, 2714, 2715, 12, GumpButtonType.Reply, 0 );

			//AddHtmlLocalized( 120, 275, 280, 20, 1011261, false, false ); // Lift a ban
            AddHtml(120, 275, 280, 20, "Remover Ban", false, false); // Lift a ban
            ...
            AddHtml(45, 150, 355, 30, "Transferir Casa", false, false); // Transfer ownership of the house
            ...
            AddHtml(45, 180, 355, 30, "Demoliar a Casa", false, false); // Demolish house and get deed back
			...
			if ( !m_House.Public )
			{
                ...
                AddHtml(45, 210, 355, 30, "Trocar as Fechaduras", false, false); // Change the house locks
                ...
                AddHtml(45, 240, 350, 90, "Tornar a Casa Pública (sua porta ficará sempre aberta)", false, false); // Declare this building to be public. This will make your front door unlockable.
			...
			else
			{
                ...
                AddHtml(45, 210, 350, 30, "Trocar Assinatura", false, false); // Change the sign type
                ...
                AddHtml(45, 240, 350, 30, "Tornar a Casa Privada", false, false); // Declare this building to be private.
                AddButton( 20, 240, 2714, 2715, 17, GumpButtonType.Reply, 0 );
                ...
                AddHtml(200, 305, 129, 20, "Alterar Assinatura de Guilda", false, false); // Guild sign choices
                AddButton( 350, 305, 252, 253, 0, GumpButtonType.Page, 5 );

				//AddHtmlLocalized( 200, 340, 355, 30, 1011277, false, false ); // Okay that is fine.
                AddHtml(200, 340, 355, 30, "OK", false, false); // Okay that is fine.
                ...
                AddHtml(200, 305, 129, 20, "Alterar Assinatura de Shop", false, false); // Shop sign choices
	...
	public class RenamePrompt : Prompt
	{
		...
		public override void OnResponse( Mobile from, string text )
		{
			if ( m_House.IsFriend( from ) )
			{
				...
				from.SendMessage( "Assinatura Alterada." );
			}
		}
	}
}