...
namespace Server.Gumps
{
	public class GuildAdminCandidatesGump : GuildMobileListGump
	{
		...
		{
            AddHtml(20, 10, 400, 35, "Aceitar ou Recusar candidatos para Administração da Guilda", false, false); // Accept or Refuse candidates for membership

			AddButton( 20, 400, 4005, 4007, 1, GumpButtonType.Reply, 0 );
            AddHtml(55, 400, 245, 30, "Aceitar", false, false); // Accept

			AddButton( 300, 400, 4005, 4007, 2, GumpButtonType.Reply, 0 );
            AddHtml(335, 400, 100, 35, "Recusar", false, false); // Refuse
		}
