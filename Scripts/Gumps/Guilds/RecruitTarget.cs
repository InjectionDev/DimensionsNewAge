	...
	public class GuildRecruitTarget : Target
	{
		...
		protected override void OnTarget( Mobile from, object targeted )
		{
			...
			if ( targeted is Mobile )
			{
				...
				{
                    m_Mobile.SendMessage("Ele ja pertence a outra Guilda!");
