...
namespace Server.Gumps
{
	...
	public class AdminGump : Gump
	{
		...
		{
			CommandSystem.Register( "Admin", AccessLevel.GameMaster, new CommandEventHandler( Admin_OnCommand ) );
		}
		...
		public AdminGump( Mobile from, AdminGumpPage pageType, int listPage, ArrayList list, string notice, object state ) : base( 50, 40 )
		{
            ...
            AddBackground(0, 0, 420, 440, 9270);
		...
		private void Shutdown( bool restart, bool save )
		{
            ...
            Logger.LogMessage("Server Shutdown by command", "Dev");
			Core.Kill( restart );
		}
