...
namespace Server.Gumps
{
	...
	public class PolymorphGump : Gump
	{
		...
		public PolymorphGump( Mobile caster, Item scroll ) : base( 50, 50 )
		{
            ...
            AddHtml(0, 0, 510, 18, "<center>Polymorph</center>", false, false); // <center>Polymorph Selection Menu</center>
			...
			for ( int i = 0; i < m_Entries.Length; i++ )
			{
				...
				if ( pos == 0 )
				{
					if ( page > 1 )
					{
                        ...
                        AddHtml(440, 376, 60, 20, "Próximo", false, false); // Next
					}
					...
					if ( page > 1 )
					{
                        ...
                        AddHtml(340, 376, 60, 20, "Voltar", false, false); // Back
					}
				}
