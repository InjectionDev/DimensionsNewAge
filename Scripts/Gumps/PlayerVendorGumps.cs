...
namespace Server.Gumps
{
	...
	public class PlayerVendorOwnerGump : Gump
	{
		...
		public PlayerVendorOwnerGump( PlayerVendor vendor ) : base( 50, 200 )
		{
			...
			AddPage( 0 );
            AddBackground(25, 10, 530, 140, 9270);

            AddHtml(425, 25, 120, 20, "Ver Itens", false, false); // See goods
			AddButton( 390, 25, 4005, 4007, 1, GumpButtonType.Reply, 0 );
            AddHtml(425, 48, 120, 20, "Customizar", false, false); // Customize
			AddButton( 390, 48, 4005, 4007, 2, GumpButtonType.Reply, 0 );
            AddHtml(425, 72, 120, 20, "Cancelar", false, false); // CANCEL
	...
	public class PlayerVendorCustomizeGump : Gump
	{
		...
		public PlayerVendorCustomizeGump( Mobile v, Mobile from ) : base( 30, 40 )
		{
			...
			AddPage( 0 );
            AddBackground(0, 0, 585, 393, 9270);
			AddBackground( 195, 36, 387, 275, 3000 );
            AddHtml(10, 10, 565, 18, "<center>CUSTOMIZAR VENDEDOR</center>", false, false); // <center>VENDOR CUSTOMIZATION MENU</center>
            AddHtml(60, 355, 150, 18, "Confirmar", false, false); // OKAY
			AddButton( 25, 355, 4005, 4007, 1, GumpButtonType.Reply, 0 );
            AddHtml(320, 355, 150, 18, "Cancelar", false, false); // CANCEL
			...
			for ( int i=0;i<Categories.Length;i++ )
			{
				...
				if ( cat.CanDye )
				{
                    AddHtml(327, 239, 100, 18, "Cor", false, false); // Color
					AddRadio( 327, 259, 210, 211, false, 100+i );
				}

                AddHtml(456, 239, 100, 18, "Remover", false, false); // Remove
