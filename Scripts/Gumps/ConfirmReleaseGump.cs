...
namespace Server.Gumps
{
	public class ConfirmReleaseGump : Gump
	{
		...
		public ConfirmReleaseGump( Mobile from, BaseCreature pet ) : base( 50, 50 )
		{
            ...
            AddBackground(0, 0, 270, 120, 9270);
			AddBackground( 10, 10, 250, 100, 3000 );

			AddHtml( 20, 15, 230, 60, "Tem certeza que deseja libertar o seu pet ?", true, true ); // Are you sure you want to release your pet?

			AddButton( 20, 80, 4005, 4007, 2, GumpButtonType.Reply, 0 );
            AddHtml(55, 80, 75, 20, "Continuar", false, false); // CONTINUE

			AddButton( 135, 80, 4005, 4007, 1, GumpButtonType.Reply, 0 );
            AddHtml(170, 80, 75, 20, "Cancelar", false, false); // CANCEL
		}
