...
namespace Server.Gumps
{
	public class RunebookGump : Gump
	{
		...
		private void AddBackground()
		{
			...
			// Charges
			AddHtml( 140, 40,  80, 18, "Cargas:", false, false ); // Charges:
			AddHtml( 220, 40, 30, 18, m_Book.CurCharges.ToString(), false, false );

			// Max charges
            AddHtml(300, 40, 100, 18, "Max Cargas", false, false); // Max Charges:
		...
		private void AddIndex()
		{
            ...
            AddHtml(158, 22, 100, 18, "Renomear Book", false, false); // Rename book
		...
		private void AddDetails( int index, int half )
		{
			...
			if ( index < m_Book.Entries.Count )
			{
                ...
                AddHtml(150 + (half * 160), 115, 100, 18, "Retirar Runa", false, false); // Drop rune
                ...
                AddHtml(175 + (half * 140), 15, 100, 18, "Restaurar padrão", false, false); // Set default
		...
		private class InternalPrompt : Prompt
		{
			...
			{
                from.SendMessage("Cancelado"); // Request cancelled.
